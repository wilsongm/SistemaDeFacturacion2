        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Billings_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stocks_Billings_BillingId",
                        column: x => x.BillingId,
                        principalTable: "Billings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Stocks_Entries_EntryId",
                        column: x => x.EntryId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Stocks_BillingId",
                table: "Stocks",
                column: "BillingId");

            migrationBuilder.CreateIndex(
                name: "IX_Stocks_EntryId",
                table: "Stocks",
                column: "EntryId");
